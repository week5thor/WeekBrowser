...
// НА GITHUB ОНОВЛЮВАТИСЯ НІЧОГО НЕ БУДЕ, ОСКІЛЬКИ РОЗРОБНИК НЕ ЗБИРАЄТЬСЯ МИРИТИСЯ З ВИМОГОЮ ПОСТАВИТИ ДВОФАКТОРНУ АУТЕНТИФІКАЦІЮ. ПРОГРАМА ТА ВИХІДНИЙ КОД БУДУТЬ ПУБЛІКУВАТИСЯ В ТЕЛЕГРАМ. ПОСИЛАННЯ В КІНЦІ README //
