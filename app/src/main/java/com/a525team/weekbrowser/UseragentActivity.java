...
public class UseragentActivity extends Activity {
	...
	private SkinAutoCompleteTextView autocomplete3;
...
*/
	...
	public void onResume() {
		...
		Skin.getInstance().setStaticBG(this, 2, true);
	}
	...
	public void _ualist() {
		...
		{HashMap<String, Object> _item = new HashMap<>();
			...
			_item.put("n", 
			"(V)Android 16 (Samsung Galaxy S9 | Chrome 149)"
			
			);_item.put("u", 
			
			"Mozilla/5.0 (Linux; Android 16; SM-G960U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.7827.103 Mobile Safari/537.36"
			
			);ua.add(_item);}
		{HashMap<String, Object> _item = new HashMap<>();
			
			_item.put("n", 
			"(V)Android 16 (LG K20 | Firefox 151)"
			
			);_item.put("u", 
			
			"Mozilla/5.0 (Android 16; Mobile; LG-M255; rv:151.0) Gecko/151.0 Firefox/151.0"
		...
		{HashMap<String, Object> _item = new HashMap<>();
			...
			_item.put("n", 
			"(X)Android 6.0 (Nexus 5 | Chrome 79)"
		...
		{HashMap<String, Object> _item = new HashMap<>();
			...
			_item.put("n", 
			"(V)iOS 18.0.9 (iPhone | Safari 18.0)"
			
			);_item.put("u", 
			
			"Mozilla/5.0 (iPhone; CPU iPhone OS 18_0_9 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.0 Mobile/15E148 Safari/604.1"
	...
	public void _uapclist() {
		...
		{HashMap<String, Object> _item = new HashMap<>();
			...
			_item.put("n", 
			"(V)Windows 10 (Chrome 125)"
			
			);_item.put("u", 
			
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.6376.0 Safari/537.36"
		...
		{HashMap<String, Object> _item = new HashMap<>();
			...
			_item.put("n", 
			"(?)Windows 8 (Chrome 115)"
			
			);_item.put("u", 
			
			"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5790.102 Safari/537.36"
			
			);uapc.add(_item);}
		{HashMap<String, Object> _item = new HashMap<>();
			
			_item.put("n", 
			"(X)Windows 7 (Chrome 115)"
		...
		{HashMap<String, Object> _item = new HashMap<>();
			...
			_item.put("n", 
			"(?)MacOS 14.2.3 (Safari 18)"
			
			);_item.put("u", 
			
			"Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2_3) AppleWebKit/616.7 (KHTML, like Gecko) Version/18.0 Safari/616.7"
