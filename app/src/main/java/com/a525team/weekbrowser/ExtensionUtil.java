...
public class ExtensionUtil {
    ...
    public void onPageFinished(WebView webView, String url) {
        ...
        // Метод для обробки події onProgress
    public void onProgress100(WebView webView) {
        for (ExtensionConfig extension : extensions) {
            if (extension.isEnabled()) {
                String script = extension.getOnProgress100Script();
                if (script != null) {
                    webView.evaluateJavascript(script, null);
                }
            }
    ...
    private static class ExtensionConfig {
        ...
        private String onProgress100Script;
        ...
        public ExtensionConfig(JSONObject jsonObject) {
            try {
                ...
                onProgress100Script = JSutil.replaceInstruction(jsonObject.optString("pr", null));
        ...
        public String getOnProgress100Script() {
            return onProgress100Script;
        }
