...
public class CustomthemeActivity extends Activity {
	...
	private SkinTextView styletitle;
	private SkinTextView stylename;
	private SkinSeekBar style;
	private LinearLayout linear6;
	private SkinButton prev9;
	private SkinButton prev10;
	private SkinButton prev1;
	private SkinButton prev3;
	private SkinButton prev4;
	private SkinButton prev5;
	private SkinButton prev6;
	private SkinButton prev7;
	private SkinButton prev8;
	private SkinCheckBox prevcheck;
	private RadioGroup radiogroup1;
	private SkinRadioButton prevradio;
	private SkinRadioButton prevradip;
	private SkinButton prev2;
	...
	private SkinTextView gradientind;
	private SkinSeekBar grad;
	private LinearLayout linear8;
	private SkinTextView segmentsind;
	private SkinSeekBar segm;
	private SkinTextView textview9;
	private SkinTextView sharpnessind;
	private SkinSeekBar sharp;
	private SkinTextView textview3;
	private SkinTextView radiusind;
	private SkinSeekBar rad;
	private SkinTextView textview4;
	private SkinTextView centerxind;
	private SkinSeekBar x;
	private SkinTextView textview5;
	private SkinTextView centeryind;
	private SkinSeekBar y;
	private SkinTextView textview6;
	private SkinTextView bigroundind;
	private SkinSeekBar bb;
	private SkinTextView textview7;
	private SkinTextView smallroundind;
	private SkinSeekBar sb;
	private SkinTextView textview2;
	private SkinButton button9;
	...
	private void initialize(Bundle _savedInstanceState) {
			...
			public void onProgressChanged(SeekBar _param1, int _param2, boolean _param3) {
				...
				switch((int)_progressValue) {
					...
					case ((int)3): {
						...
						stylename.setText("Material Dark");
						break;
					}
					case ((int)4): {
						sf.edit().putString("style", "6").commit();
						stylename.setText("Material Light");
		...
		autogen.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				AlertDialog dddddd = generator.create();
				RenderUtils.setupDialogDim(CustomthemeActivity.this, dddddd);
				dddddd.show();
			...
			public void onProgressChanged(SeekBar _param1, int _param2, boolean _param3) {
				...
				if (_progressValue == 0) {
					switch((int)state) {
							...
							sf.edit().putString("tm", "0").commit();
							break;
						}
						case ((int)1): {
							sf.edit().putString("rtm", "0").commit();
							break;
						}
						case ((int)2): {
							sf.edit().putString("btm", "0").commit();
					...
					switch((int)state) {
							...
							sf.edit().putString("tm", String.valueOf((long)(Math.pow(2, _progressValue - 1)))).commit();
							break;
						}
						case ((int)1): {
							sf.edit().putString("rtm", String.valueOf((long)(Math.pow(2, _progressValue - 1)))).commit();
							break;
						}
						case ((int)2): {
							sf.edit().putString("btm", String.valueOf((long)(Math.pow(2, _progressValue - 1)))).commit();
		...
		button9.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				switch((int)state) {
						...
						sf.edit().putString("strcou", String.valueOf((long)(Math.max(2, col.size())))).commit();
						break;
					}
					case ((int)1): {
						sf.edit().putString("rstrcou", String.valueOf((long)(Math.max(2, col.size())))).commit();
						break;
					}
					case ((int)2): {
						sf.edit().putString("bstrcou", String.valueOf((long)(Math.max(2, col.size())))).commit();
		...
		button8.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				for (int i = 0; i < col.size(); i++) {
					try {
						long colorLong = Long.parseLong(col.get(i).get("c").toString(), 16);
						int colorInt = (int) (colorLong & 0xFFFFFFFFL);
						sb.append(_toHexStr(colorInt));
					} catch(Exception e) {
						sb.append(col.get(i).get("c").toString());        
					}
				}
				buffer = sb.toString();
				switch ((int) state) {
...
*/
	...
	public void _colToRAM() {
		...
		skin.updateBG(this, 2);
		//catch(Exception e){}
		skin.notifyObservers();
		switch((int)state){
			case 0: prev2.setSkinKey("bbg", false);break;
			case 1: prev2.setSkinKey("rbg", false);break;
		}
	}
	...
	public void _updind() {
		...
		switch(((state == 2) ? (sf.getString("bgrad", "")) : (((state == 1) ? (sf.getString("rgrad", "")) : (sf.getString("grad", "")))))) {
			...
			case "6": {
				gradientind.setText(getString(R.string.chessgrad) + " 𒁈");
				rad.setVisibility(View.GONE);
				radiusind.setVisibility(View.GONE);
				x.setVisibility(View.VISIBLE);
				centerxind.setVisibility(View.VISIBLE);
			...
			case "7": {
				gradientind.setText(getString(R.string.altchessgrad) + " 𒁈");
				rad.setVisibility(View.GONE);
				radiusind.setVisibility(View.GONE);
				x.setVisibility(View.VISIBLE);
				centerxind.setVisibility(View.VISIBLE);
			...
			case "8": {
				gradientind.setText(getString(R.string.triangles) + " 𒁈");
				rad.setVisibility(View.GONE);
				radiusind.setVisibility(View.GONE);
				x.setVisibility(View.VISIBLE);
				centerxind.setVisibility(View.VISIBLE);
			...
			case "9": {
				gradientind.setText(getString(R.string.rect_tri) + " 𒁈");
				rad.setVisibility(View.GONE);
				radiusind.setVisibility(View.GONE);
				x.setVisibility(View.VISIBLE);
				centerxind.setVisibility(View.VISIBLE);
			...
			case "10": {
				gradientind.setText(getString(R.string.hexagon) + " 𒁈");
				rad.setVisibility(View.GONE);
				radiusind.setVisibility(View.GONE);
				x.setVisibility(View.VISIBLE);
				centerxind.setVisibility(View.VISIBLE);
			...
			case "11": {
				gradientind.setText(getString(R.string.dragon_s) + " 𒁈");
				rad.setVisibility(View.GONE);
				radiusind.setVisibility(View.GONE);
				x.setVisibility(View.VISIBLE);
				centerxind.setVisibility(View.VISIBLE);
			...
			case "12": {
				gradientind.setText(getString(R.string.random_shapes) + " 𒁈⚠️");
				rad.setVisibility(View.VISIBLE);
				radiusind.setVisibility(View.VISIBLE);
				x.setVisibility(View.VISIBLE);
				centerxind.setVisibility(View.VISIBLE);
	...
	public void _setseekbars() {
		...
		switch((int)((state == 2) ? ((int)Integer.parseInt(sf.getString("btm", ""))) : ((int)((state == 1) ? ((int)Integer.parseInt(sf.getString("rtm", ""))) : ((int)Integer.parseInt(sf.getString("tm", ""))))))) {
			...
			case ((int)64): {
				sharp.setProgress((int)7);
				break;
			}
			case ((int)128): {
				sharp.setProgress((int)8);
	...
	public void _openPicker(final int _position) {
		SharedPreferences sf = getSharedPreferences("sf", Context.MODE_PRIVATE);
