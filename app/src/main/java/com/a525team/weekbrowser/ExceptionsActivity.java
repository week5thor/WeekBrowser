...
public class ExceptionsActivity extends Activity {
			...
			public boolean onItemLongClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				del.setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface _dialog, int _which) {
						...
						FileUtil.writeFile(getFilesDir().getPath()+"/sitepermis.json", new Gson().toJson(except));
	...
	private void initializeLogic() {
		except = new Gson().fromJson(FileUtil.readFile(getFilesDir().getPath()+"/sitepermis.json"), new TypeToken<ArrayList<HashMap<String, Object>>>(){}.getType());
