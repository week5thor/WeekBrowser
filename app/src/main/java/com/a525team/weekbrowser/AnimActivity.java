...
public class AnimActivity extends Activity {
	...
	private SkinTextView listanimt;
	private Spinner lap;
	private Spinner lai;
	private SkinTextView bpanimt;
	private Spinner bap;
	private Spinner bai;
	private SkinTextView spanimt;
	private Spinner sap;
	private Spinner sai;
	private SkinButton ssh;
	private SkinTextView textview1;
	private SkinButton bsh;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		lap.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				Skin.getInstance().colorToRam(AnimActivity.this);
			}
