...
public class SsuperactivityActivity extends Activity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		ad.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				if (isAd) {
					...
					try{
						blockad.setTitle("?");
						blockad.setMessage(getString(R.string.blocksite1)+"\n".concat(_extractDomain(Datas.get("src").toString())).concat(getString(R.string.blocksite2).concat(Datas.get("src").toString())));
		...
		button4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), ShortcutActivity.class);
				intent.setData(Uri.parse(((!isNotNullOrEmpty(Datas, "url")) ? ("") : (Datas.get("url").toString()))));
				intent.putExtra("n", ((!isNotNullOrEmpty(Datas, "title")) ? ("") : (Datas.get("title").toString())));
				intent.putExtra("m", "");
				startActivity(intent);
			}
		});
