...
public class HistoryActivity extends Activity {
	...
	private SkinButton showhide;
	private ListView listview1;
	private ListView listview2;
	private SkinTextView numofelem;
	private SkinTextView hintt;
	private SkinSeekBar seekbar1;
	private SkinCheckBox time;
	private LinearLayout linear5;
	private SkinButton deletee;
	private SkinCheckBox regex;
	private SkinAutoCompleteTextView autocomplete2;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		listview1.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						switch((int)which) {
							...
							case ((int)9): {
									...
									AdBlocker.getInstance(HistoryActivity.this).showBlockDialog(HistoryActivity.this, history.get((int)_position).get("url").toString(), null);
								}catch(Exception e){
				...
				RenderUtils.setupDialogDim(HistoryActivity.this, dddddd);
				dddddd.show();
	...
	private void initializeLogic() {
		...
		Skin.getInstance().setBG(linear1, 2, false);
...
*/
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			final com.a525team.weekbrowser.SkinTextView textview3 = _view.findViewById(R.id.textview3);
			final com.a525team.weekbrowser.SkinTextView textview2 = _view.findViewById(R.id.textview2);
