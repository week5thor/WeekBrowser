...
public class LockActivity extends Activity {
	...
	private SkinTextView ucan;
	private SkinTextView code;
	...
	private SkinButton k1;
	private SkinButton k2;
	private SkinButton k3;
	private SkinButton k4;
	private SkinButton k5;
	private SkinButton k6;
	private SkinButton k7;
	private SkinButton k8;
	private SkinButton k9;
	private SkinButton erase;
	private SkinButton k0;
	private SkinButton done;
...
*/
	...
	private void initializeLogic() {
		...
		final SharedPreferences sf = getSharedPreferences("code", Context.MODE_PRIVATE);
		final SharedPreferences sf0 = getSharedPreferences("sf", Context.MODE_PRIVATE);
...
*/
		if ((WTF.SDK_INT() >= android.os.Build.VERSION_CODES.M && isBiometricAvailable(this)) && sf0.getString("usefingerprint", "1").equals("1")) {
