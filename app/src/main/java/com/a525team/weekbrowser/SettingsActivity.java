...
public class SettingsActivity extends Activity {
	...
	private Button clrfav;
	private CheckBox clrfava;
...
*/
	...
	public void _theme() {
		try{
			...
			skin.setBG(github, 0, false);
			skin.setBG(githubc, 0, false);
			...
			skin.setBG(toolspan, 0, false);
			skin.setBG(dbg, 0, false);
			
			skin.setBG(clrfav, 0, false);
			...
			github.setTextColor((int)Long.parseLong(dataHolder.getData("bt"),16));
			githubc.setTextColor((int)Long.parseLong(dataHolder.getData("bt"),16));
			...
			clrfav.setTextColor((int)Long.parseLong(dataHolder.getData("bt"),16));
			...
			smss.setTextColor((int)Long.parseLong(dataHolder.getData("add"),16));
			prevexit.setTextColor((int)Long.parseLong(dataHolder.getData("t"),16));
			
			toolspan.setTextColor((int)Long.parseLong(dataHolder.getData("bt"),16));
			dbg.setTextColor((int)Long.parseLong(dataHolder.getData("bt"),16));
	...
	public void _info() {
		...
		sm.add("JavascriptInterface (Android 4.4+, best 5.0+)");
	}
	...
	public void _getFolSize() {
		...
		clrfav.setText(getString(R.string.clear_favicon) + " (" + Formater.kimgt(getFolderSize(new File(getFilesDir().getPath()+"/favicons"))) + "B)");
	}
