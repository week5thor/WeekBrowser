...
public class ThemeManager {
	...
	public static void applyTheme(Context context) {
		...
		if(WTF.SDK_INT()>=11 && sf.getString("cstyle", "").equals("")){
			...
			switch (themeValue) {
				case 0:
				theme = (WTF.SDK_INT() >= 14) ?
				android.R.style.Theme_DeviceDefault_Light_NoActionBar : android.R.style.Theme_Holo_Light_NoActionBar;
				light = true;
				break;
				case 1:
				theme = (WTF.SDK_INT() >= 14) ?
				android.R.style.Theme_DeviceDefault_NoActionBar : android.R.style.Theme_Holo_NoActionBar;
				light = false;
				break;
				case 2:
                a1 = true;
